...
import { IIngredientModel, instanceOfIIngredientModel } from "../models/Ingredient";
 ...
 */
export async function createRecipe(recipe: IRecipeModel): Promise<IRecipeModel> {
 ...
 */
export function createMenu(menu: IMenuModel): Promise<IMenuModel> {
 ...
 * @returns {Promise<MenuDoc>}
 */
export function updateMenu(menuId: String, updateObject: IMenuModel): Promise<IMenuModel> {
 ...
 * @returns {Promise<RecipeDoc>}
 */
export async function updateRecipe(recipeId: String, updateRecipe: IRecipeModel): Promise<IRecipeModel> {
 ...
 * @returns {Promise<RecipeDoc>}
 */
export async function convertRecipe(recipe: IRecipeModel): Promise<IRecipeModel> {
    // Bad code here
    ...
    recipe.ingredients.forEach((ingredient) => {
        ...
        if (instanceOfIIngredientModel(ingredient.description)) {
